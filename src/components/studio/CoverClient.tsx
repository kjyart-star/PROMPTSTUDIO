          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 relative">
              ...
              <div 
                ...
                className={`border-2 border-dashed rounded-xl p-6 flex flex-col items-center justify-center cursor-pointer transition-colors ${uploadedFileUrl ? 'border-primary bg-primary/5' : 'border-[#1e1e1e] hover:border-primary/50 hover:bg-[#0a0a0a]'}`}
              >
                <input 
                  type="file" 
                  accept="audio/*" 
                  ...
                  <>
                    ...
                    <p className="text-sm font-bold text-primary">오디오 준비 완료</p>
                     <button
                      ...
                      className="mt-4 px-4 py-2 bg-[#0a0a0a] border border-[#1a1a1a] hover:border-primary/50 text-zinc-200 hover:text-white text-xs font-bold rounded-xl transition-all flex items-center gap-2 cursor-pointer shadow"
                     >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between p-3 rounded-xl bg-[#0a0a0a] border border-[#1a1a1a]">
                ...
                <button 
                  ...
                  className={`w-11 h-6 rounded-full transition-colors flex items-center px-1 cursor-pointer ${generateForm.instrumental ? 'bg-primary' : 'bg-zinc-800'}`}
                >
            ...
            {!generateForm.customMode && (
              <div className="space-y-1">
                ...
                <textarea 
                  ...
                  rows={3}
                  className="w-full h-24 bg-[#0a0a0a] border border-[#1a1a1a] rounded-xl p-3 text-xs text-zinc-200 resize-none focus:outline-none focus:border-primary/60 transition-colors custom-scrollbar"
                />
              </div>
            )}
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold border transition-colors ${generateForm.vocalGender === 'm' ? 'bg-primary text-black border-primary' : 'bg-[#0a0a0a] text-zinc-400 border-[#1a1a1a] hover:border-zinc-700'}`}
                  >
                  ...
                  <button 
                    ...
                    className={`px-4 py-2 rounded-xl text-xs font-bold border transition-colors ${generateForm.vocalGender === 'f' ? 'bg-primary text-black border-primary' : 'bg-[#0a0a0a] text-zinc-400 border-[#1a1a1a] hover:border-zinc-700'}`}
                  >
              ...
              {activeAudioList.length > 0 ? (
                <div className="flex flex-col gap-4">
                  ...
                  {activeAudioList.map((audio: any, idx: number) => (
                    <div key={idx} className="flex items-center justify-between gap-4 p-4 bg-[#0a0a0a] rounded-xl border border-[#1a1a1a] w-full">
                      <div className="flex items-center gap-4">
                        {audio.image_url ? (
                          <img src={audio.image_url} alt="Cover" className="w-16 h-16 rounded-lg object-cover" />
                        ) : (
                          <div className="w-16 h-16 bg-[#161616] rounded-lg flex items-center justify-center border border-[#232323] text-zinc-500">
                ...
                <div className="flex flex-col items-center justify-center p-8 bg-[#0a0a0a] rounded-xl border border-[#1a1a1a] h-full">
                  <div className="w-12 h-12 border-4 border-primary border-t-transparent rounded-full animate-spin mb-4"></div>
                  <p className="text-sm text-primary font-bold">{uiLanguage === 'KO' ? '커버 음원을 생성 중입니다...' : uiLanguage === 'JA' ? 'カバーを生成中...' : 'Generating covers...'}</p>
                ...
                <div className="flex flex-col items-center justify-center h-full text-center space-y-4 opacity-70 relative z-10 py-12">
                  <div className="w-16 h-16 rounded-full bg-[#0a0a0a] border border-[#1a1a1a] flex items-center justify-center mb-2 shadow-lg">
