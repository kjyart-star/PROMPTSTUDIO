...
export default function StudioRootLayout({
  ...
  return (
    ...
    <div className="cm-studio min-h-screen md:h-screen md:min-h-0 md:overflow-hidden bg-surface-container-lowest text-zinc-100 flex flex-col selection:bg-[#0c9965]/40 selection:text-white">
