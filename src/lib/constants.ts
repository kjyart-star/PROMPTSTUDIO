...
export const GENRES: Genre[] = [
  ...
  { name: 'Hip Hop', korean: '힙합', japanese: 'ヒップホップ', color: 'bg-[#a21caf]', q: 'hip hop', image: withBase('/images/genres/genre_hiphop.png') },
  { name: 'R&B', korean: '알앤비', japanese: 'R&B', color: 'bg-[#1db954]', q: 'r&b', image: withBase('/images/genres/genre_rnb.png') },
  ...
  { name: 'City Pop', korean: '시티팝', japanese: 'シティ・ポップ', color: 'bg-[#14b8a6]', q: 'city pop', image: withBase('/images/genres/genre_citypop.png') },
  ...
  { name: 'Trot', korean: '트로트', japanese: 'トロット', color: 'bg-[#fbbf24]', q: 'trot', image: withBase('/images/genres/genre_trot.png') },
  { name: 'Blues', korean: '블루스', japanese: 'ブルース', color: 'bg-[#0f172a]', q: 'blues', image: withBase('/images/genres/genre_blues.png') },
  { name: 'Country', korean: '컨트리', japanese: 'カントリー', color: 'bg-[#509bf5]', q: 'country', image: withBase('/images/genres/genre_country.png') },
  ...
  { name: 'Reggae', korean: '레게', japanese: 'レゲエ', color: 'bg-[#15803d]', q: 'reggae', image: withBase('/images/genres/genre_reggae.png') },
  ...
  { name: 'Funk Soul', korean: '펑크 소울', japanese: 'ファンク/ソウル', color: 'bg-[#b45309]', q: 'funk soul', image: withBase('/images/genres/genre_funksoul.png') },
  ...
  { name: 'Podcasts', korean: '팟캐스트', japanese: 'ポッドキャスト', color: 'bg-[#509bf5]', q: 'podcasts', image: withBase('/images/genres/genre_podcasts.png') },
