...
const defaultFolderBtnRegex = /<button[\s\S]*?onClick=\{\(\) => setSelectedPlaylistFilter\('default'\)\}[\s\S]*?<\/button>/;
...
console.log('Successfully applied second round of UI patches to ProfileClient.tsx!');
